...
MANUAL_OVERRIDES: dict[str, tuple[str, str]] = {
    ...
    # Новинки драже из июньского импорта 2026
    "Драже Чернослив в ТШ 90гр": ("Драже", "Драже классика"),
    "Драже Миндаль в ТШ 90г": ("Драже", "Драже классика"),
    "Драже Курага в МШ 90гр": ("Драже", "Драже классика"),
